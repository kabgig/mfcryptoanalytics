...
CREATE TABLE public.trade_overrides (
    ...
    CONSTRAINT trade_overrides_trend_chk CHECK (((trend IS NULL) OR (trend = ANY (ARRAY['with_trend'::text, 'against_trend'::text]))))
);
